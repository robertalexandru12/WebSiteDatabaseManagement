  ...
  <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    ...
    <%@page import="DAOImpl.ConstructoriDaoImpl" %>
        ...
        <head>
          ...
          <link href="assets/css/style_constructori.css" rel="stylesheet">
        ...
        <body>
            ...
            <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
              ...
              <nav id="navbar" class="navbar">
                <ul>
                  ...
                  <li><a class="active" href="Constructori.jsp">Constructori</a></li>
          ...
          <section id="hero" class="hero">
            <div class="container">
              <table class="table-scroll small-first-col">
                ...
                <tbody class="body-half-screen">
                  <c:forEach var="constructori" items="${listaConstructori}">
                    <tr>
                      <td>${constructori.idconstructor}</td>
                      <td>${constructori.nume}</td>
                      <td>${constructori.prenume}</td>
                      <td>${constructori.salariu}</td>
                      <td>
                        <button class="deleteButtonClass" name="${constructori.idconstructor}" onclick="clickDeleteButton(this)">
                        ...
                        <button class="editButtonClass" name="${constructori.idconstructor}" onclick="clickEditButton(this)">
            ...
            <div class="signupSection">
              <div class="info2">
                <h2>Adauga constructori</h2>
                <i class="icon ion-ios-ionic-outline" aria-hidden="true"></i>
                <p>in baza de date</p>
                <p>destinata acestora</p>
              </div>
              <form id="myForm" action="ConstructoriController" method="POST" class="signupForm" name="signupform"
                ...
                <ul class="noBullet">
                  ...
                  <li>
                    ...
                    <input type="text" class="inputFields" id="salariu" name="salariu" placeholder="Salariu" value="">
                  </li>
                  <li id="center-btn">
                    <input type="submit" id="ptAdaugat" class="join-btn" name="adaugaConstructor" alt="Adauga Constructor"
                      value="Adauga Constructor">
                  </li>
                  <li id="center-btn">
                    <input type="submit" id="ptAfisat" class="join-btn" name="afiseazaConstructori" alt="Afiseaza datele"
                      onclick="submitForm()" value="Afiseaza Datele">
                  </li>
                </ul>
              </form>
            </div>
            ...
            <div id="id01" class="modal">
              ...
              <form class="modal-content" action="ConstructoriController" method="POST">
                <div class="containerModal">
                  <h1>Sterge Client</h1>
                  <p id="textModalConfirmation">Esti sigur ca vrei sa stergi clientul cu id-ul %ID%?</p>

                  <div class="clearfix">
                    <input type="hidden" name="idconstructor" id="idconstructor" value="123" />
                    <button id="confirmButton" type="button" onclick="closeDeleteModal(this)"
                      class="cancelbtn">Anuleaza</button>
                    <button id="confirmButton" type="submit" name="stergeConstructor" class="deletebtn">Sterge</button>
                  </div>
                </div>
              </form>
            </div>
            ...
            <div id="id02" class="modal2">
              ...
              <form class="modal-content2" action="ConstructoriController" method="POST">
                <div class="containerModal2">
                  <div class="form">
                    ...
                    <input type="hidden" name="idconstructorEdit" id="idconstructorEdit" value="1234" />
                      ...
                      <label for="salariuEdit"></label>
                      <input id="salariuEdit" name="salariuEdit" class="input" type="text" placeholder="Salariu" />
                      <label> </label>
                    <button type="submit" name="modificaConstructor" class="submit">Modifica</button>
                  </div>
                </div>
              </form>
            </div>
          ...
          <script>
            ...
            function clickDeleteButton(button) {
              ...
              var idconstructorInput = document.getElementById("idconstructor");
              idconstructorInput.value = btnId;
          ...
          <script>
            ...
            function clickEditButton(button) {
              ...
              var idconstructorInput = document.getElementById("idconstructorEdit");
              idconstructorInput.value = btnId;
